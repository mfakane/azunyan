...
internal sealed class FakeEditorView : IEditorView
{
    ...
    public int ScrollSelectionIntoViewCount { get; private set; }
    ...
    public void ScrollSelectionIntoView() => ScrollSelectionIntoViewCount++;
...
internal sealed class FakeFindReplaceView : IFindReplaceState, IFindReplaceHost
{
    ...
    public void SetResult(int current, int total) => Result = $"{current}/{total}";

    public void ShowNotification(string message, bool replaceMode) => Notification = message;
